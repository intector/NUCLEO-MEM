...
## Removed Messages (from WPT version)

The following message types no longer exist:

| Old Type         | Replacement        |
|------------------|--------------------|
| `wpt-status`     | `led-status`       |
| `wpt-boost`      | `telemetry`        |
| `wpt-hbridge`    | `telemetry`        |
| `boost-command`  | `led-command`      |
| `hbridge-command`| `led-command`      |
| Binary telemetry | *(removed entirely)* |
