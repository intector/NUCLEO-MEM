...
void __attribute__ ((weak, naked)) PVD_AVD_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) ADC3_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel0_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel2_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel3_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel4_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel5_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel6_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) BDMA_Channel7_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) COMP1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) LPTIM4_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) LPTIM5_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) SAI4_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) I2C5_EV_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void I2C5_EV_IRQHandler();
	__asm("bkpt 255");
	__asm("bx lr");
}
void __attribute__ ((weak, naked)) I2C5_ER_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void I2C5_ER_IRQHandler();
	__asm("bkpt 255");
	__asm("bx lr");
}
void __attribute__ ((weak, naked)) FDCAN3_IT0_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) FDCAN3_IT1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void FDCAN3_IT1_IRQHandler();
	__asm("bkpt 255");
	__asm("bx lr");
}
void __attribute__ ((weak, naked)) TIM23_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
...
void __attribute__ ((weak, naked)) TIM24_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void TIM24_IRQHandler();
	__asm("bkpt 255");
	__asm("bx lr");
}
...
void I2C5_EV_IRQHandler()             __attribute__ ((weak, alias ("Default_Handler")));
void I2C5_ER_IRQHandler()             __attribute__ ((weak, alias ("Default_Handler")));
...
void TIM23_IRQHandler()               __attribute__ ((weak, alias ("Default_Handler")));
void TIM24_IRQHandler()               __attribute__ ((weak, alias ("Default_Handler")));
#endif
...
void * g_pfnVectors[0xb3] __attribute__ ((section (MAKE_SECTION_NAME_STRING(VECTOR_TABLE_SECTION_NAME)), used)) =
{
	&_estack,
	&Reset_Handler,
	&NMI_Handler,
