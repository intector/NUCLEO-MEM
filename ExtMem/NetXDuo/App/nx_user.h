...
/// #define NX_WEB_HTTP_FRAGMENT_OPTION             NX_FRAGMENT_OKAY // ((ULONG)0x00000000)
...
#define NX_WEB_HTTP_MAX_RESOURCE                0xFF
...
/* Specifies the number of simultaneous sessions for an HTTP or HTTPS Server.
   ...
   session. Set to 1 to minimize AXI SRAM packet pool usage; browser requests
   are serialized sequentially over a single connection. */
...
#define NX_WEB_HTTP_SERVER_TRANSMIT_QUEUE_DEPTH   15
