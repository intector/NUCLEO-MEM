...
static UCHAR scratch[FX_STM32_MMC_DEFAULT_SECTOR_SIZE] __attribute__((section(".dma_buffer"), aligned(32)));
#else
static UCHAR scratch[FX_STM32_MMC_DEFAULT_SECTOR_SIZE] __attribute__((section(".dma_buffer"), aligned(4)));
#endif
