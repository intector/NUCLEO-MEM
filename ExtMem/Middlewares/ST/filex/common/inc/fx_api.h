...
#define FX_FAT_MAP_SIZE                        256  /* Minimum 1, maximum any. This represents how many 32-bit words used for the written FAT sector bit map. */
#endif
