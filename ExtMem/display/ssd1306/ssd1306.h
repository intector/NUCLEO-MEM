...
#pragma region // ***** I2C configuration stuff *****
...
#pragma region // ***** SPI configuration stuff *****
...
#pragma region // ***** display specific settings *****
...
typedef struct {
    SSD1306_VERTEX Start; // start position
    SSD1306_VERTEX End; // end position
} SSD1306_RECT;
